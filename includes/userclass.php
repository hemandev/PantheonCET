...
{ 
  ...
  public function register($name,$mail,$phone,$college,$workshop,$accom,$userId)
  {
    try
    {
      ...
      $stmt = $this->conn->prepare("INSERT INTO register(name,email,phone,college,workshop,accom,user_id) 
                                                   VALUES(:name,:email,:phone,:college,:workshop,:accom,:user_id)");
